 ...
 * 		return partition             # <<<<<<<<<<<<<<
 * 
 * #	def bulk_union(self, demand_vectors):
 */
...
static PyObject *__pyx_pw_11disjointset_11DisjointSet_5bulk_union(PyObject *__pyx_v_self, PyObject *__pyx_arg_demand_vectors) {
  ...
  assert(__pyx_arg_demand_vectors); {
    __pyx_v_demand_vectors = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5numpy_int8_t(__pyx_arg_demand_vectors, PyBUF_WRITABLE); if (unlikely(!__pyx_v_demand_vectors.memview)) __PYX_ERR(0, 91, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
